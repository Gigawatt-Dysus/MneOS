const fs = require('fs');
// Let's use the actual Tailscale UNC path to read the binary data of an edited image
const filePath = '\\\\100.116.12.18\\gga_lifeos_vault_alpha\\2014 Year End Review\\2014\\02\\DSC_1274-edited.JPG';
