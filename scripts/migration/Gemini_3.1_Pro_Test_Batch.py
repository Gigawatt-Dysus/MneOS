...
# Using Gemini 3.1 Pro via Vertex AI SDK for a strict 100-image test batch
...
try:
    print("\n🚀 Running Gemini 3.1 Pro TEST BATCH (100 images maximum)...")
    m_res = process_collection("media")
