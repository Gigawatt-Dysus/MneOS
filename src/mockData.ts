...
// Updated Gigi's avatar to use a reliable external service since image2url is offline
export const GIGI_AVATAR_URL = 'https://ui-avatars.com/api/?name=Gigi&background=0D8ABC&color=fff&size=256';
export const ZOE_AVATAR_URL = 'https://ui-avatars.com/api/?name=Zoe&background=8B5CF6&color=fff&size=256';
...
export const mockMedia: Media[] = [
  { 
    ...
    mediaIds: [] // [ZEN FIX] Added missing required prop
  },
  { 
    id: 'media2', 
