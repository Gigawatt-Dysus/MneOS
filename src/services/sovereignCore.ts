import { db, collection } from './sovereignDbAdapter';
...
export const VERTEX_REQUESTS_COLLECTION = 'vertex_requests';
export const VERTEX_COLLECTION = 'verts';
export const PEER_CHAT_SESSIONS_COLLECTION = 'peer_chat_sessions';
export const TRANSMISSIONS_COLLECTION = 'transmissions';
export const MEMORIAL_CONTRIBUTIONS_COLLECTION = 'memorial_contributions';
