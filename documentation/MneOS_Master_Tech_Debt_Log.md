...
- [ ] **Media & Nano Banana Session Ingestion Routing:** Revisit whether to filter/discard Nano Banana and image prompt sessions or route them into a dedicated `MEDIA_PROMPTS` vault folder or MongoDB `media_sessions` collection (See `documentation/ADR-026-Media_and_Nano_Banana_Session_Routing.md`).
