...
import { Bot, PenTool, X } from 'lucide-react';
...
export const NeuralAgentsSidebar: React.FC<NeuralAgentsSidebarProps> = ({ agents, onAgentSelect, onInjectMessage }) => {
    ...
    return (
        <div className="h-full flex flex-col bg-slate-900/50 backdrop-blur-md border-r border-white/5 w-[80px] items-center py-4 gap-4">
