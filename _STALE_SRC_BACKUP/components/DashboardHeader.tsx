...
const DashboardHeader: React.FC = () => {
    ...
    return (
        <div className="bg-black/20 backdrop-blur-md py-4 px-6 font-mona-sans text-white text-center shadow-lg rounded-xl w-full mx-auto mb-6 border border-white/5">
