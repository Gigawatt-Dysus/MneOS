                ...
                <div className="space-y-6 text-xs font-mono">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <input type="password" value={config.geminiKey} onChange={e => setConfig({...config, geminiKey: e.target.value})} className="w-full bg-black border border-[#00ffcc]/30 p-2 text-[#00ffcc]" placeholder="Gemini Key" />
